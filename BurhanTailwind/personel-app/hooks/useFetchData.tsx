...
import { PRODUCTS_URL, PRODUCT_BY_ID_URL, SELLER_PROFILE } from "../constant/urls"
...
const useFetchData = () => {
  ...
  return {products, productId, loading, sellerProfile, getSellerById, fetchAllData, fetchDataById, addProduct}
}
